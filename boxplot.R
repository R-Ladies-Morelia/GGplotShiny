...
## Por si el link no funciona
tabla.df <- vroom("Periodic _Table _of _Elements.csv")
...
p2 <- ggplot(data = filtrada.df, aes(x=Type, y=Density, color=Type)) + 
  geom_boxplot()
